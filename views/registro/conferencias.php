    ...
    <p class="pagina__descripcion">Elije hasta 5 eventos para asistir de manera presencial.</p>

    <div class="eventos-registro">
        <main class="eventos-registro__listado">  
            
                <h3 class="eventos-registro__heading--conferencias">&lt;Conferencias /></h3>
                <p class="eventos-registro__fecha">Viernes 5 de Obtubre</p> 
                ...
                <p class="eventos-registro__fecha">Sábado 6 de Obtubre</p> 
