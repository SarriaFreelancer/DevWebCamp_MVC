<main class="auth">
    ...
    <form name="logoForm" method="POST" action="/registro" class="formulario">
        ...
        <div style="display:none" class="formulario__campo">
            <input 
            type="text"
            class="formulario__input"
        ...
        <input id="submitBtn" type="submit" class="formulario__submit" value="Crear Cuenta">
    </form>
